        ...
        rows.append(
            {
                ...
                "trend_filter_status": audit.get("trend_filter_status"),
                "trend_filter_reason": audit.get("trend_filter_reason"),
                "trend_ma_short": audit.get("trend_ma_short"),
                "trend_ma_long": audit.get("trend_ma_long"),
                "price_vs_ma_long_pct": audit.get("price_vs_ma_long_pct"),
...
def _render_markdown(rows: list[dict]) -> str:
    ...
    lines.extend(
        [
            ...
            "- `trend_filter_status`、`trend_ma_short`、`trend_ma_long`：用于核对趋势过滤是否生效。",
